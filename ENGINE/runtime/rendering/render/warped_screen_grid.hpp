...
public:
    ...
    struct RealismSettings {
        ...
        float layer_light_overlap_padding_px = 24.0f;
        float layer_light_depth_padding_world = 18.0f;
        int layer_light_membership_hold_frames = 4;
        float layer_light_depth_transition_world = 30.0f;
        bool dark_mask_temporal_enabled = true;
        float dark_mask_temporal_prev_weight = 0.65f;
        float player_layer_hysteresis_world = 22.0f;
