...
public:
    ...
    int live_dynamic_max_spawn_from_room_px() const;
    void set_live_dynamic_max_spawn_from_room_px(int value, bool persist = true);
...
private:
    ...
    int live_dynamic_max_spawn_from_room_px_ = 128;
};
