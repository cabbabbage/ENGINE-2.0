...
std::vector<std::string> default_metric_order() {
    return {
        ...
        "enemy_ai.perception.horizontal_distance_sq",
        "enemy_ai.perception.vertical_delta_px",
        "enemy_ai.movement_goal.kind",
        "enemy_ai.movement_goal.status",
        "enemy_ai.movement_goal.changed",
        "enemy_ai.movement_goal.change_count",
        "enemy_ai.movement_goal.reason",
        "enemy_ai.attack_profile",
        "enemy_ai.attack_phase",
        "enemy_ai.attack_contact_fallback_enabled",
        "enemy_ai.attack_commit_start_count",
        "enemy_ai.attack_commit_runtime_count",
        "enemy_ai.attack_commit_hit_count",
        "enemy_ai.attack_commit_whiff_count",
        ...
        "assets.active_activation_count",
        "assets.active_activation_skipped_count",
        "assets.active_rebuild_forced_same_frame",
        "assets.active_fail_open_applied",
        "assets.active_fail_open_frames",
        "assets.active_fail_open_reason",
        "assets.traversal_complete",
        "assets.traversal_projection_budget_exhausted",
        "assets.traversal_points_without_projection",
        "assets.traversal_camera_mismatch_deferred",
        "assets.traversal_retry_attempted",
        "assets.traversal_retry_produced_candidates",
        "assets.traversal_frame_id",
        "assets.pipeline.movement_flush_frame",
        "assets.pipeline.movement_flush_camera_state",
        "assets.pipeline.camera_state_before_world_update",
        "assets.pipeline.camera_state_after_world_update",
        "assets.pipeline.camera_state_before_grid_rebuild",
        "assets.pipeline.pre_rebuild_active_chunk_count",
        "assets.pipeline.traversal_count_after_camera_rebuild",
        "assets.pipeline.traversal_complete_after_camera_rebuild",
        "assets.pipeline.traversal_budget_exhausted_after_camera_rebuild",
        "assets.pipeline.post_rebuild_active_chunk_count",
        "assets.pipeline.active_publish_count_after_rebuild",
        "assets.world_ms",
        ...
        "render.scene_motion_active",
        "render.held_scene_attempted",
        "render.held_scene_suppressed_by_motion",
        "render.scene_motion_signal_current",
        "render.scene_motion_signal_previous",
        ...
        "asset_runtime_animation_load.asset_name",
        "asset_runtime_animation_load.animation_name",
        "asset_runtime_animation_load.ms",
        "asset_runtime_animation_load.loaded",
        "asset_runtime_animation_load.deferred",
        "asset_runtime_animation_load.fallback_used",
