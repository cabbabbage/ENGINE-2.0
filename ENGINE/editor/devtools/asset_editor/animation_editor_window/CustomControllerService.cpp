...
void CustomControllerService::write_controller_files(const std::filesystem::path& header_path,
    ...
    if (!header_exists) {
        ...
        hpp << "#ifndef " << guard << "\n";
        hpp << "#define " << guard << "\n\n";
        hpp << "#include \"animation/controllers/custom_controller.hpp\"\n";
        hpp << "#include <optional>\n\n";
        hpp << "class Asset;\n";
        hpp << "class Input;\n\n";
        hpp << "class " << class_name << " : public custom_controller_api::CustomControllerBase {\n\n";
        hpp << "public:\n";
    ...
    if (!source_exists) {
        ...
        cpp << "    : custom_controller_api::CustomControllerBase(self) {\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_init() {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_init();\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_update(const Input& in) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_update(in);\n";
        ...
        cpp << "    custom_controller_api::CustomControllerBase::on_attack(attack);\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_hit(const animation_update::Attack& attack) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_hit(attack);\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_death() {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_death();\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_no_pending_attacks() {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_no_pending_attacks();\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_after_attack() {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_after_attack();\n";
        cpp << "}\n\n";
        cpp << "custom_controller_api::AttackProcessingConfig " << class_name << "::attack_processing_config() const {\n";
        cpp << "    return custom_controller_api::CustomControllerBase::attack_processing_config();\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_orphaned_hook(Asset& self,\n";
        cpp << "                                               Asset* former_parent,\n";
        cpp << "                                               std::optional<OrphanImpulse> impulse) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_orphaned_hook(self, former_parent, impulse);\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_pre_delete_hook(Asset& self) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_pre_delete_hook(self);\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_process_pending_attacks(Asset& self_ref) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_process_pending_attacks(self_ref);\n";
        cpp << "}\n\n";
        cpp << "void " << class_name << "::on_interact_hook(Asset& self, Asset* instigator) {\n";
        cpp << "    custom_controller_api::CustomControllerBase::on_interact_hook(self, instigator);\n";
        cpp << "}\n";
    }
}
