...
bomb_controller::bomb_controller(Assets* assets, Asset* self)
...
void bomb_controller::update(const Input&) {
...
void bomb_controller::process_pending_attacks(Asset& self) {
