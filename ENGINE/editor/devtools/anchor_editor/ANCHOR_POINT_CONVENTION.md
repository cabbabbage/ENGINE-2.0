...
- Anchors also store integer `depth_offset` (signed world-pixel units). Runtime applies this by moving from the flat texture-relative 3D point along the camera-to-point ray by `depth_offset`.
